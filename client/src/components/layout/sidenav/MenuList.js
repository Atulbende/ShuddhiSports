...
import Size from '../../Application/Keyword/Size';
export const  Menu=[ 
    ...
    {title:'Administration',icon:'fa fa-address-card', access:[3,4,5,6,9,10,11,12,13,14],
        subMenu:[
                ...
                subMenu:[
                    ...
                    {title:'Size',  link:'/size',   component:<Size/>, access:[13,14]}
                ]}
        ]},
]
export const  Routers=[ 
    ...
    {title:'Category',link:'/category',component:<Category/>,access:[9,10]},
    {title:'Brand',link:'/brand',component:<Brand/>,access:[11,12]},
    {title:'Size',link:'/size',component:<Size/>,access:[13,14]}
